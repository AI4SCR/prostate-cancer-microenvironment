...
results_dir <- file.path(output_figures_dir, "figure6", "niches")
dir.create(results_dir, showWarnings = FALSE, recursive = TRUE)
figures_dir <- file.path(output_figures_dir, "figure6", "niches")
...
cols <- "tumorERG+p53+_ProlifLuminal" # niche 6
...
for (col in cols) {
  ...
  # print(p_prog)
  # legacy bug: hardcoded to a different script's niches, never matched this
  # script's `cols`, so this panel never saved -- see bugs.md
