...
ggsave(
  p_full,
  filename = file.path(figures_dir, "violin_boxplot_stromogenic_sep.pdf"),
  width = 12,
  height = 18,
  dpi = 300
)
...
ggsave(
  p_full,
  filename = file.path(figures_dir, "violin_boxplot_stromogenic.pdf"),
  width = 12,
  height = 6,
  dpi = 300
)

cat("Saved Figure 7a panels to", figures_dir, "\n")
